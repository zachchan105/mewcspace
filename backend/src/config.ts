...
const defaults: IConfig = {
  'MEMPOOL': {
    ...
    'POOLS_JSON_URL': 'https://raw.githubusercontent.com/meowcoin-foundation/mining-pools-mewc/master/pools.json',
    'POOLS_JSON_TREE_URL': 'https://api.github.com/repos/meowcoin-foundation/mining-pools-mewc/git/trees/master',
    'AUDIT': false,
  ...
  'EXTERNAL_DATA_SERVER': {
    'MEMPOOL_API': 'https://explorer.mewccrypto.com/api/v1',
