...
init();`;
  ...
  wrapCommonJS(code: any) {
    ...
    if (code.codeTemplate) {
      ...
      const importText = `<script src="https://explorer.mewccrypto.com/mempool.js"></script>`;
...
yarn add @mempool/mempool.js`;
  ...
  wrapPythonTemplate(code: any) {
    return ( ( this.network === 'testnet' ) ? ( code.codeTemplate.python.replace( 'wss://explorer.mewccrypto.com/api/v1/ws', 'wss://explorer.mewccrypto.com/' + this.network + '/api/v1/ws' ) ) : code.codeTemplate.python );
  }
