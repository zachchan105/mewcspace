...
if __name__ == "__main__":
    ws = websocket.WebSocketApp("wss://explorer.mewccrypto.com/api/v1/ws",
                              on_open=on_open,
  ...
  },
  {
    ...
    codeExample: {
      default: {
        ...
        const response = await fetch(\`https://explorer.mewccrypto.com/api/address/\${address}/utxo-hex\`);
...
export const faqData = [
  ...
  },
  {
    ...
    title: "How big is the mempool used by explorer.mewccrypto.com?",
